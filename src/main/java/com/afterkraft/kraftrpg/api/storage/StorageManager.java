...
public interface StorageManager extends Manager {
    ...
    /**
     * Set the current storage. WARNING: DOING THIS AFTER ALL DATA IS LOADED MAY LEAD
     * TO DATA LOSS.
    ...
    /**
     * Return the currently configured {@link com.afterkraft.kraftrpg.api.storage.RPGStorage} for RPGPlugin.
