...
public interface Active<T extends SkillArgument> extends ISkill {
    ...
    /**
     * Performs checks that this skill can be casted by this
     * {@link com.afterkraft.kraftrpg.api.entity.Champion}
     * <p/>
     * It is not required to override this method unless customized checks
     * need to be performed on top of the current checks.
     * <p/>
     * It is possible to force the champion to cast this skill with the forced
     * argument to ignore any
     * {@link com.afterkraft.kraftrpg.api.entity.roles.Role#hasSkill(ISkill)}
     * checks within.
     *
     * @param caster
    ...
    /**
     * Cast this skill according to this skill's defined SkillArgument. This
     * can be used in instances like bound skills to Items and
     *
     * @param caster - The Champion to cast this skill
     * @param argument - The SkillArgument to use this skill with
     * @return the SkillCastResult for using the skill with the given
     *         argument.
     */
