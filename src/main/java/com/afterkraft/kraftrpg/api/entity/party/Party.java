...
/**
 * Party is a grouping of {@link com.afterkraft.kraftrpg.api.entity.Champion}s. Useful for
 * maintaining close contact with friendly Champions and the ability to apply buffing
 * effects to the Party. Parties add a new chat channel.
 *
...
public interface Party {
     ...
     * check if the Champion is not already in a party, and if they are, the Champion's
    ...
    /**
     * Attempts to add the requested {@link com.afterkraft.kraftrpg.api.entity.Champion} to this Party.
     * If forced, the Champion's previous party (if any) will be removed and the Champion will be added
     * to this party. If not, the same behavior of {@link #addChampion(com.afterkraft.kraftrpg.api.entity.Champion)} will
     * take place.
     *
     * @param champion being added to this party.
     * @param forced if true, ignore any existing parties the Champion is part of and re-assign the Champion to this party.
